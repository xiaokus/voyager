...
@section('page_header')
    <h1 class="page-title">
        <i class="{{ $dataType->icon }}"></i> @if(isset($dataTypeContent->id)){{ '编辑' }}@else{{ '添加' }}@endif {{ $dataType->display_name_singular }}
    </h1>
@stop
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">@if(isset($dataTypeContent->id)){{ '编辑' }}@else{{ '添加' }}@endif {{ $dataType->display_name_singular }}</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form"
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="permissions checkbox">
                                ...
                                ?>
                                @foreach(Xiaokus\Voyager\Models\Permission::all()->groupBy('table_name') as $table => $permission)
                                    <li>
